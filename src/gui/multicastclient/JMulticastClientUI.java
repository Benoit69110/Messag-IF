...
import net.multicastclient.ListenerThread;
import net.multicastclient.MulticastListener;

/**
 * Interface Graphique pour le client Multicast distribué.
...
public class JMulticastClientUI extends JFrame implements MulticastListener {
	...
	/**Bouton pour s'abonner à un groupe multicast*/
	private Button join;
	/**Bouton pour résilier un abonnement à un groupe multicast*/
	private Button leave;
	/**Bouton pour effacer la zone d'affichage des messages*/
	private Button clear;
	/**Bouton pour envoyer un message*/
	private Button send;
	/**Boite de sélection des groupes multicasts auxquels le client est abonné*/
	...
	/**
	 * Envoi du message au groupe multicast dont les coordonnées sont actuellement saisies dans les champs groupIPField et groupPortField.
	 * @param msg
	 * */
	 ...
	 * @param thread Le processus d'écoute qui a reçu le message: il est lié à un abonnement à un groupe multicast.
	 * @param msg Le message reçu par le processus.
	 * */
	@Override
	...
	/**
	 * Méthode appelée lors de la résiliation d'un abonnement à un groupe multicast.
	 * Ecriture d'un message d'avertissement dans la zone d'affichage des messages.
	 * @param thread Le processus d'écoute qui a résilié son abonnement multicast.
	 * */
	@Override
